...
<body class="text-center">
    <form class="form-signin" action="/admin/login.php" method="POST">
        ...
        <input type="text" id="username-input" name="username" class="form-control" placeholder="admin" required>
        <label for="pw-input" class="sr-only">Password</label>
        <input type="password" id="pw-input" name="pw" class="form-control" placeholder="passwort123" required>
